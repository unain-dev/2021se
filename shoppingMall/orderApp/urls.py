...
urlpatterns=[
    ...
    path('paySuccess/', order_views.paySuccess, name='paySuccess'),
    path('payFail/', order_views.payFail, name="payFail"),
    ...
    path('directCancle/', order_views.direct_pay_cancle, name="direct_pay_cancle"),
]