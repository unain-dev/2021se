...
CREATE TABLE `shoppingapp_useraccounts` (
  ...
  `user_address` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `shoppingapp_useraccounts` VALUES (1,'dd','jkadjskf','dkajskdlj','sdklafjkl@dklfjalkf',293480329,'djkafjl'),(2,'test','djfkfl','sdkfja','123@abc.com',24234,'dskfjl');
